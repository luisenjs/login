        ...
        <>
            <div className={className}>
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-left">Today is a new day. It's your day. You shape it. Sign in to start</p>
                </div>
                <form className="flex flex-col gap-4" onSubmit={handleSubmit(enviardatos)}>
                ...
                <div className="flex flex-col gap-2">
                    <button className="w-full bg-gray-200 rounded-lg p-2 hover:bg-gray-300">Sign up with Google</button>
                    <button className="w-full bg-gray-200 rounded-lg p-2 hover:bg-gray-300">Sign up with Facebook</button>
                </div>
