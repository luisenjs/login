...
export const MainLayout = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col max-w-screen">
            <header className="fixed w-full h-28 bg-slate-500 p-4 flex justify-between items-center">
                <div>
                ...
                <Button className="max-w-14 text-red-500" onClick={logout} isPrincipal={false}><LogOut /></Button>
            </header>
